...
const createProduct = async (product) => {
  const { description, height, width, profileType, glassType, shutterType, pricePerUnit, quantity, idDoor, idWindow } = product;
  ...
  return new Promise((resolve, reject) => {
    db.query(query, [description, height, width, profileType, glassType, shutterType, pricePerUnit, quantity, idDoor, idWindow], (error, results) => {
      if (error) {
...
const updateProduct = async (idProduct, product) => {
  ...
  return new Promise((resolve, reject) => {
    db.query(
      query,
      [description, profileType, glassType, shutterType, width, height, quantity, pricePerUnit, idDoor, idWindow, idProduct],
      (err, result) => {
        if (err) {
...
const calculateProfiles = async (productIds) => {
