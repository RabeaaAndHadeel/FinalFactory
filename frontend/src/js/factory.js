        ...
        {factory.map((data, i) => (
          <div key={i} className={classes.card}>
            ...
            <div className={classes.item}>
              {editingIndex === i ? (
                <>
                  <img src={save} alt="save" className={classes.icon} onClick={handleSave} />
                  <img src={close} alt="cancel" className={classes.icon} onClick={handleCancel} />
                </>
              ) : (
                <img src={edit} alt="edit" className={classes.icon} onClick={() => handleEdit(i, data)} />
              )}
            </div>
          </div>
        ))}
